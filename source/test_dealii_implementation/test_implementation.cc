...
#include "multigrid/portable_mg_transfer_global_coarsening.h"
#include "multigrid/portable_mg_transfer_global_coarsening.templates.h"
...
LaplaceProblem<dim, fe_degree>::solve()
{
  ...
  Portable::VCycleMultigrid<dim, double, Portable::MGTransferBase<dim, double>>
    mg_preconditioner(level_matrices, mg_transfers, mg_smoothers, 5, 5);
